  ...
  render(){
   let {
    ...
    const imgWindows = this.props.offsetArray.map(offset=>{
      return <li style={{width:'30 vw', overflow:'hidden', height:'25vh'}}><img src={imgArray[indexOffset(imgArray, offset, index)]}></img></li>
    })
